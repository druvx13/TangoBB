...
$LANG = array(
    ...
    'admin' => array(
        ...
        'shown_subforums' => 'Number of shown subforums',
        'enable_register' => 'Enable Register',
        'merge_posts' => 'Merge Posts',
        'merge_posts_tooltip' => 'Merge consecutive posts by the same user.',
        'enable_flat_ui' => 'Enable Flat UI for ACP',
        'enable_flat_ui_tooltip' => 'Use the old FlatUI interface on the administration panel.',
        'default_language' => 'Default Language',
        'forum_rules' => 'Forum Rules',
        'forum_rules_message' => 'HTML tags will be converted into ascii codes.',
        'captcha_settings' => 'Captcha Settings',
        'captcha_message' => 'The public and private keys are <strong>required</strong> for reCaptcha.',
        ...
        'smtp_port' => 'SMTP Port',
        'send_email_smtp' => 'Send email using SMTP.',
        'facebook_settings' => 'Facebook Settings',
        'facebook_message' => 'The Facebook application ID and secret are <strong>required</strong> for Facebook Authentication.',
        'facebook_app_id' => 'Facebook App ID',
        'facebook_app_secret' => 'Facebook App Secret',
        'enable_facebook_auth' => 'Enable Facebook Authentication',
        'save_settings' => 'Save Settings',
        'save_success' => 'Information saved!',
        'save_error' => 'Error saving information. Try again later.'
    ),
    'notification' => array(
